...
namespace Auxillary {//ÒÔÂˆËÙËÍ‡ˆËˇ  ÙÛÌÍˆËÈ(‚ÒÔÓÏÓ„‡ÚÂÎ¸Ì˚ı)
	template<typename T>
	struct sum {
...
class ISorter {//‡·ÒÚ‡ÍÚÌ˚È ÍÎ‡ÒÒ ÒÓÚËÓ‚ÓÍ
public:
	virtual void sort(typename Sequence<T, _Iterators>::iterator, typename Sequence<T, _Iterators>::iterator, bool (T, T) = cmp__up(T)) = 0;//‘”Õ ÷»ﬂ Õ»’”ﬂ Õ≈ ƒ≈À¿≈“ “»œŒ PASS ¡Àﬂ“‹ 
	virtual SortType GetType() = 0;
};


template<class T, class _Iterators>//“”“  À¿—— Õ¿—À≈ƒ”≈“—ﬂ Œ“ ¬≈–’Õ≈√Œ, ÕŒ —¿Ã Õ¿œ»—¿Õ ¡”ƒ≈“ œŒ«∆≈   
...
template<typename T, class _Iterators>//ƒ¬Œ≈“Œ◊»≈ “»œŒ “”“ ‘”Õ ÷»» Œœ»—€¬¿≈Ã ” ›“»’ 5 Õ¿—ŒÀ≈ƒŒ¬¿ÕÕ€’  À¿——Œ¬
